import{o as wi,_ as to,e as Ts}from"./vendor-M4lLRkkP.js";var lc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TT(n=ro()){return KE().then(e=>{if(!e)throw be.create("unsupported-browser")},e=>{throw be.create("indexed-db-unsupported")}),vn(J(n),"messaging").getImmediate()}async function IT(n,e){return n=J(n),cd(n,e)}$E();export{cT as A,dT as B,sT as C,ET as D,lt as G,pT as a,vT as b,yT as c,hl as d,tT as e,fT as f,uv as g,rT as h,JE as i,uT as j,lT as k,nT as l,TT as m,IT as n,rp as o,aT as p,GE as q,mT as r,oT as s,iT as t,_T as u,hT as v,HE as w,zE as x,YE as y,QE as z};
